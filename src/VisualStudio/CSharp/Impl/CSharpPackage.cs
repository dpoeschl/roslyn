...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.LanguageService
{
    ...
    [ProvideLanguageEditorOptionPage(typeof(Options.Formatting.FormattingStylePage), "CSharp", @"Code Style", @"Code Style", pageNameResourceId: "#114", keywordListResourceId: 313)]
