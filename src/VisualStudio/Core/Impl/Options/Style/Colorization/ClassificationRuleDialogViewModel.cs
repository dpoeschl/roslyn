...
{
    internal partial class ClassificationRuleDialogViewModel : AbstractNotifyPropertyChanged
    {
        public ClassificationRuleDialogViewModel(
            string name,
            ...
            IList<ClassificationStyleViewModel> namingStyleList,
            ClassificationStyleTreeViewModel parent,
            IList<ClassificationStyleTreeViewModel> allowableParentList)
        {
            this.name = name;
            ...
            allowableParentList.Insert(0, new ClassificationStyleTreeViewModel("-- None --"));
        ...
        private ClassificationStyleViewModel namingStyle;
