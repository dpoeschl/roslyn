...
class Goo
{
    ...
    void Method(object obj, int num = 23, string str = "")
    {
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27445")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
public class Goo
{
        ...
        <WorkItem(544940, "http://vstfdevdiv:8080/DevDiv2/DevDiv/_workitems/edit/544940")>
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27440")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
class C
{
    ...
    void M()
    {
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27456")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
using goo = System$$]]></Document>)
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/29109")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
class C
{
    void goo()
    {
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27442")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
class C
{
    void M()
    {
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27448")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
...
class C
{
    void goo() {
        ...
        <InlineData(CompletionImplementation.Legacy)>
        <InlineData(CompletionImplementation.Modern, Skip:="https://github.com/dotnet/roslyn/issues/27449")>
        <WpfTheory, Trait(Traits.Feature, Traits.Features.Completion)>
