    ...
    internal class EditorAsyncCompletionItemManager : IAsyncCompletionItemManager
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var snapshotForDocument = data.InitialSortedList
                .FirstOrDefault(i => i.Properties.ContainsProperty(CompletionItemSource.TriggerBuffer))?.
                Properties.GetProperty<ITextBuffer>(CompletionItemSource.TriggerBuffer).CurrentSnapshot ?? data.Snapshot;
