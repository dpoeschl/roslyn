...
#End If
        ...
        Public Function AssertSessionIsNothingOrNoCompletionItemLike(text As String) As Task Implements ITestState.AssertSessionIsNothingOrNoCompletionItemLike
