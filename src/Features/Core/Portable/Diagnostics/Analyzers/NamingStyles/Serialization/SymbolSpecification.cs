...
namespace Microsoft.CodeAnalysis.Diagnostics.Analyzers.NamingStyles
{
    ...
    internal class SymbolSpecification
    {
        ...
        [DataMember(IsRequired = true)]
        public List<SymbolKindOrTypeKind> ApplicableSymbolKindList { get; set; }
        [DataMember(IsRequired = true)]
        public List<AccessibilityKind> ApplicableAccessibilityList { get; set; }
        [DataMember(IsRequired = true)]
        public List<ModifierKind> RequiredModifierList { get; set; }
