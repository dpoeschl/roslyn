    ...
    internal class SymbolSpecification
    {
        ...
        internal SymbolSpecification()
        {
            ...
            ModifierList = new List<ModifierKind>
                {
                    new ModifierKind(DeclarationModifiers.Abstract),
                    new ModifierKind(DeclarationModifiers.Async),
                    new ModifierKind(DeclarationModifiers.Const),
                    new ModifierKind(DeclarationModifiers.ReadOnly),
